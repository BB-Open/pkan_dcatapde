...
class CatalogAddSchema(ICatalog):
    ...
    # is an unstored python object, you can ask it for attributes to create or set publisher
...
class CatalogAddForm(add.DefaultAddForm):
    ...
    def updateWidgets(self, prefix=None):
        ...
        self.widgets['new_publisher'].template = ViewPageTemplateFile("templates/oneline.pt")
    ...
    def handleAdd(self, action):
        ...
        try:
            ...
            raise ActionExecutionError(Invalid(translate(e.message, target_language=get_current_language())))
